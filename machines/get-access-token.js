module.exports = {
  ...
  description: 'Generate a new access token for acting on behalf of a particular Facebook account.',
  ...
  exits: {
    ...
    success: {
      description: 'Returns the access token which allows you to do things and get information on behalf of a particular Facebook user.',
      example: {
